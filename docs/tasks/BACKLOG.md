...
**Last updated:** 2025-10-31T12:30:00Z
...
### ⚙️ TASK-027: Заменить заголовки на Flomoon и обновить название приложения

**Category:** chore | **Priority:** 🟡 medium | **Status:** in-progress
...
**Notes:** Задача переименования приложения с Nastya/Настя на Flomoon. Изменение чисто косметическое и конфигурационное - не требует логических изменений функционала, просто обновление названия во всех видимых местах для согласованного брендинга.
